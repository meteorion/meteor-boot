package pers.meteor.gateway.util;
...
public class SecurityFrameworkUtils {
     ...
     * @param user 用户
     */
    public static void setLoginUser(ServerWebExchange exchange, AuthUserDetail user) {
     ...
     */
    @SneakyThrows
    public static void setLoginUserHeader(ServerHttpRequest.Builder builder, AuthUserDetail user) {
        try {
