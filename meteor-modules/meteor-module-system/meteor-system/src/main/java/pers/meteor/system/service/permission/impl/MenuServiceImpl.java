package pers.meteor.system.service.permission.impl;
...
import pers.meteor.system.convert.permission.MenuConverter;
import pers.meteor.system.enums.SystemConstants;
import pers.meteor.system.mapper.permission.MenuMapper;
import pers.meteor.system.model.permission.entity.Menu;
import pers.meteor.system.model.permission.enums.MenuTypeEnum;
...
import pers.meteor.system.service.permission.RoleMenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    private RouteVO toRouteVo(Menu menu) {
        ...
        meta.setHidden(SwitchStatusEnum.CLOSE.getCode() == menu.getVisible());
        // 【菜单】是否开启页面缓存
        ...
        if (StrUtil.isNotBlank(paramsJson)) {
            ...
            try {
                Map<String, String> paramMap = objectMapper.readValue(paramsJson, new TypeReference<Map<String, String>>() {
                });
    ...
    public boolean saveMenu(MenuForm menuForm) {
        ...
        List<KeyValue<String, String>> params = menuForm.getParams();
    ...
    public MenuForm getMenuForm(Long id) {
        ...
        if (StrUtil.isNotBlank(params)) {
            ...
            try {
                ...
                Map<String, String> paramMap = objectMapper.readValue(params, new TypeReference<Map<String, String>>() {
                });

                // 转换为 List<KeyValue> 格式 [{key:"id", value:"1"}, {key:"name", value:"张三"}]
                List<KeyValue<String, String>> transformedList = paramMap.entrySet().stream()
