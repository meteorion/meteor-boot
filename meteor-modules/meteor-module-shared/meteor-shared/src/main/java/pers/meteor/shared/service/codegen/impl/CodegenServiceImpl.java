...
public class CodegenServiceImpl implements CodegenService {
    ...
    public Page<TablePageVO> getTablePage(TablePageQuery queryParams) {
        Page<TablePageVO> page = new Page<>(queryParams.getPageIndex(), queryParams.getPageSize());
        // 设置排除的表
    ...
    public List<CodegenPreviewVO> getCodegenPreviewData(String tableName) {
        ...
        if (genConfig == null) {
            throw new ServiceException("未找到表生成配置");
        }
        ...
        if (CollectionUtil.isEmpty(fieldConfigs)) {
            throw new ServiceException("未找到字段生成配置");
        }
