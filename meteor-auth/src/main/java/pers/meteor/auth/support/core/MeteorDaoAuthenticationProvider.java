package pers.meteor.auth.support.core;
...
import pers.meteor.security.core.service.AdminUserDetailsService;
 ...
 * @date 2022-06-04
 */
public class MeteorDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public MeteorDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, AdminUserDetailsService> userDetailsServiceMap = SpringUtil
			.getBeansOfType(AdminUserDetailsService.class);

		String finalClientId = clientId;
		Optional<AdminUserDetailsService> optional = userDetailsServiceMap.values()
			.stream()
