...
import pers.meteor.security.core.conveter.CustomOAuth2AccessTokenResponseHttpMessageConverter;
...
public class AuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {
	...
	private void sendAccessTokenResponse(HttpServletRequest request, HttpServletResponse response,
		...
		OAuth2AccessTokenResponse accessTokenResponse = OAuth2EndpointUtils.sendAccessTokenResponse(accessToken, refreshToken, additionalParameters);
