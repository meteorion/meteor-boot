package com.meteor.common.file.core.client;
...
public class FileClientFactoryImpl implements FileClientFactory {
    ...
    public <T extends FileClientConfig> void createOrUpdateFileClient(Long configId, Integer storage, T config) {
        AbstractFileClient<T> client = (AbstractFileClient<T>) clients.get(configId);
        if (client == null) {
