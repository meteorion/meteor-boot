 ...
 * @author meteor
 */
public abstract class AbstractWechatPayService extends AbstractPayService<WechatPayClient> {
    protected WxPayService wxPayService;

    public AbstractWechatPayService(Long channelId, WechatPayClient config) {
