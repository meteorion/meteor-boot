package pers.meteor.system.api.permission;
...
public interface PermissionApi {
    ...
    SingleResponse<Set<Long>> getUserRoleIdListByRoleIds(@RequestParam("roleIds") Collection<Long> roleIds);
    ...
    SingleResponse<Boolean> hasAnyPermissions(@RequestParam("userId") Long userId,
    ...
    SingleResponse<Boolean> hasAnyRoles(@RequestParam("userId") Long userId,
    ...
    SingleResponse<DeptDataPermissionDTO> getDeptDataPermission(@RequestParam("userId") Long userId);
}
