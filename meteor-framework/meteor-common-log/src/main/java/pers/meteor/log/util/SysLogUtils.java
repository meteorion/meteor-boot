...
import pers.meteor.log.event.SysLogEventSource;
...
public class SysLogUtils {
	...
	public SysLogEventSource getSysLog() {
		...
		// get 参数脱敏
		MeteorLogProperties logProperties = SpringContextHolder.getBean(MeteorLogProperties.class);
