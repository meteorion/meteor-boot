package pres.meteor.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class MeteorSentinelFeign {

	private MeteorSentinelFeign() {

	}

	public static MeteorSentinelFeign.Builder builder() {
		return new MeteorSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public MeteorSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new MeteorSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new MeteorSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new MeteorSentinelInvocationHandler(target, dispatch);
				}
