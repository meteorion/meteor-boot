...
import pers.meteor.shared.SharedApplication;
import pers.meteor.shared.model.codegen.form.GenConfigForm;
import pers.meteor.shared.convert.codegen.CodegenConverter;
import pers.meteor.shared.framework.codegen.config.CodegenProperties;
import pers.meteor.shared.mapper.codegen.DatabaseMapper;
import pers.meteor.shared.mapper.codegen.GenConfigMapper;
...
import pers.meteor.shared.model.codegen.enums.FormTypeEnum;
import pers.meteor.shared.model.codegen.enums.JavaTypeEnum;
import pers.meteor.shared.model.codegen.enums.QueryTypeEnum;
...
//    private final MenuService menuService;
    ...
    public GenConfigForm getGenConfigFormData(String tableName) {
        ...
        if (genConfig == null) {
            ...
            genConfig.setPackageName(SharedApplication.class.getPackage().getName());
...
//        }
        ...
        if (CollectionUtil.isEmpty(genFieldConfigs)) {
            throw new ServiceException("字段配置不能为空");
        }
