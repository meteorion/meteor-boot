 ...
 */
@Slf4j
public class MeteorSentinelInvocationHandler implements InvocationHandler {
	...
	MeteorSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MeteorSentinelInvocationHandler other = (MeteorSentinelInvocationHandler) obj;
