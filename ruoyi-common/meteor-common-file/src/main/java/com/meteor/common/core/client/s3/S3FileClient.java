...
import com.meteor.common.core.client.AbstractFileClient;
import com.ruoyi.common.core.exception.file.FileUploadException;
import io.minio.*;

import java.io.ByteArrayInputStream;

import static com.meteor.common.core.client.s3.S3FileClientConfig.ENDPOINT_ALIYUN;
import static com.meteor.common.core.client.s3.S3FileClientConfig.ENDPOINT_TENCENT;
...
public class S3FileClient extends AbstractFileClient<S3FileClientConfig> {
    ...
    @Override
    public String upload(byte[] content, String path, String type) throws FileUploadException {
        try {
            // 执行上传
    ...
    @Override
    public void delete(String path) throws FileUploadException {
        try {
    ...
    @Override
    public byte[] getContent(String path) throws FileUploadException {
        try {
