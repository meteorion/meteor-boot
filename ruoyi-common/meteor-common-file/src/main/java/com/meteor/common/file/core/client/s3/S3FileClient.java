package com.meteor.common.file.core.client.s3;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.text.CharSequenceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.http.HttpUtil;
import com.meteor.common.file.core.client.AbstractFileClient;
import com.meteor.common.file.core.expection.FileUploadException;
import io.minio.*;
...
public class S3FileClient extends AbstractFileClient<S3FileClientConfig> {
    ...
    public String upload(byte[] content, String path, String type) throws FileUploadException {
        try {
            ...
            throw new FileUploadException("文件上传失败", e.getCause());
        }
    }
