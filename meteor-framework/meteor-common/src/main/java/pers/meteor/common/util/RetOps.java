package pers.meteor.common.util;
...
public class RetOps<T> {
	...
	/** 状态码为成功 */
	public static final Predicate<R<?>> CODE_SUCCESS = r -> GlobalErrorCode.SUCCESS.getCode() == r.getCode();
	 ...
	 * 是否成功
	 * @return 返回ture表示成功
	 * @see GlobalErrorCode#SUCCESS
	 */
	public boolean isSuccess() {
		return codeEquals(GlobalErrorCode.SUCCESS.getCode());
	}
	...
	public <Ex extends Exception> RetOps<T> assertSuccess(Function<? super R<T>, ? extends Ex> func) throws Ex {
		return assertCode(GlobalErrorCode.SUCCESS.getCode(), func);
	}
