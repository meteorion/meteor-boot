package pers.meteor.shared.service.config.impl;
...
import pers.meteor.shared.convert.config.ConfigConverter;
import pers.meteor.shared.mapper.config.ConfigMapper;
...
public class ConfigServiceImpl extends ServiceImpl<ConfigMapper, Config> implements ConfigService {
    ...
    public IPage<ConfigVO> page(ConfigPageQuery configPageQuery) {
        Page<Config> page = new Page<>(configPageQuery.getPageIndex(), configPageQuery.getPageSize());
    ...
    public boolean refreshCache() {
        redisTemplate.delete(CacheConstants.SYSTEM_CONFIG_KEY);
        ...
        if (list != null) {
            ...
            redisTemplate.opsForHash().putAll(CacheConstants.SYSTEM_CONFIG_KEY, map);
            return true;
        }
        return false;
    }
    ...
    public Object getSystemConfig(String key) {
        if (StringUtils.isNotBlank(key)) {
            return redisTemplate.opsForHash().get(CacheConstants.SYSTEM_CONFIG_KEY, key);
        }
        return null;
    }
