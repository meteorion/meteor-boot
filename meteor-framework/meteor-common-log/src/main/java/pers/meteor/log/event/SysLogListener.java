...
import pers.meteor.common.jackson.CustomeJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final MeteorLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new CustomeJavaTimeModule());
	}
