package pers.meteor.security.core.util;
...
public class OAuth2EndpointUtils {
	...
	public OAuth2AccessTokenResponse sendAccessTokenResponse(OAuth2Authorization authentication,
		...
		OAuth2RefreshToken refreshToken = Optional.ofNullable(authentication.getRefreshToken()).map(OAuth2Authorization.Token::getToken).orElse(null);

		return sendAccessTokenResponse(accessToken, refreshToken, claims);
	}

	public OAuth2AccessTokenResponse sendAccessTokenResponse(OAuth2AccessToken accessToken, OAuth2RefreshToken refreshToken,
															 Map<String, Object> claims) {
